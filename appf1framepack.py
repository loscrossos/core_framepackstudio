...
transformer = HunyuanVideoTransformer3DModelPacked.from_pretrained(resolved_paths["PATH_MODEL_FramePack_F1_I2V_HY_20250503"], torch_dtype=torch.bfloat16).cpu()
